...
export async function handler(event) {
  try {
    ...
    // Garder uniquement les champs non vides, ignorer les techniques
    ...
    entries.sort((a,b) => {
      const ai = orderIndex(a[0]), bi = orderIndex(b[0]);
...
— Fin —`;
    ...
    if (!DOMAIN || !API_KEY || !EMAIL_TO) {
      console.error('Missing env vars:', { DOMAIN: !!DOMAIN, API_KEY: !!API_KEY, EMAIL_TO: !!EMAIL_TO });
    ...
    await mg.messages.create(DOMAIN, {
      from: EMAIL_FROM,      // sandbox: postmaster@...
